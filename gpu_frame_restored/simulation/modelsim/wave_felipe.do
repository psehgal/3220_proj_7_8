...
add wave -noupdate -radix decimal /lg_highlevel/Writeback0/I_PC
add wave -noupdate -radix decimal /lg_highlevel/Writeback0/O_PC
add wave -noupdate -radix decimal /lg_highlevel/Fetch0/I_BranchStallSignal
add wave -noupdate -radix decimal /lg_highlevel/Fetch0/I_DepStallSignal
add wave -noupdate -radix decimal /lg_highlevel/Decode0/O_BranchStallSignal
add wave -noupdate -radix decimal /lg_highlevel/Decode0/O_DepStallSignal
...
add wave -noupdate -radix decimal /lg_highlevel/Execute0/I_CCValue
add wave -noupdate -radix decimal /lg_highlevel/Execute0/O_CCValue
add wave -noupdate -radix decimal /lg_highlevel/Execute0/CCValue
add wave -noupdate -radix decimal /lg_highlevel/Execute0/CCWEn
add wave -noupdate -radix decimal /lg_highlevel/Memory0/O_CCWEn
